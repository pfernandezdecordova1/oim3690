...
- Pseudo-classes: Interactive Styles.Makes the code much more readable.  
...
- I learned how to add animations and how to prompt ai to improve them for the s11 demo page. 
- I also learned how to create tables which is very easy to do and useful for work. I did an example of a random class table. 
     Flexbox is one way to do it, you use a div with a container and adding flex directions too. Its all about relationships, it has parent (div) and children inside. display flex is the useful one. 
## AI Usage. 
- For the change in colour animation when you hover over the button, You describe it to AI to create the animation, you need to explain specific transition at the beginning and the end, and the duration.
 - Al helped me create the animations for s11 and also the tables. 
